...
namespace RewardsService.Middleware;

/// <summary>
/// ASP.NET Core middleware that catches unhandled exceptions and writes a standardised JSON error response.
/// </summary>
public class GlobalExceptionMiddleware
{
    ...
    /// <summary>
    /// Invokes the next middleware and intercepts any unhandled exception for structured error handling.
    /// </summary>
